...
Developed by Izhan Ansari (izhana2024@anjumanengg.edu.in)
...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("""
    **Developer:** Izhan Ansari  
    📧 [izhana2024@anjumanengg.edu.in](mailto:izhana2024@anjumanengg.edu.in)  
    ⭐ [Project Repo](https://github.com/izhana2024-collab/stock_price_prediction)  
    """)
...
st.markdown(
    ...
    "StockAI v2.0 · Developed by <strong>Izhan Ansari</strong> (izhana2024@anjumanengg.edu.in) · "
    "<a href='https://github.com/izhana2024-collab/stock_price_prediction' target='_blank' style='color:#818cf8;'>GitHub Repository</a>"
    "</div>",
    unsafe_allow_html=True
)
